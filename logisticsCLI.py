...
def distance(city1, city2):
    ...
    Example:
    ./logisticsCLI.py distance "Delhi" "Bengaluru"
    """

    click.echo(click.style("Distance between two cities", fg="green"))
    click.echo(
        click.style(
            f"{distance_between_two_points(get_coordinates(city1), get_coordinates(city2))} km",
            fg="blue",
        )
    )
...
# assume the speed is 120 km per hour
@cli.command("travel")
@click.argument("city1")
@click.argument("city2")
...
def travel(city1, city2, speed):
    ...
    Example:
    ./logisticsCLI.py travel "Delhi" "Bengaluru"
    """
